<template>
        <form action="#" :id="form_id" method="POST" name="feedback" @submit="send" :data-goal="goal">
            ...
            <div class="control-group">
                <label :for="form_id + '_checkbox_personal_data'" class="control control-checkbox">Я согласен на <a :href="'/' + cities.active.value + '/privacy' + uri_params" class="event" target="_blank">обработку персональных данных</a>
