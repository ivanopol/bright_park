<template>
    <div>
        ...
        <div class="range-slider-wrapper">
            <vue-slider v-model="sliderOne.value" :interval="1" :marks="sliderOne.marks" :drag-on-click="true"
                        :min="sliderOne.min" :max="sliderOne.max"/>
        </div>
        ...
        <div class="range-slider-wrapper">
            <vue-slider v-model="sliderTwo.value" :interval="1" :marks="sliderTwo.marks" :drag-on-click="true"
                        :min="sliderTwo.min" :max="sliderTwo.max"/>
        </div>
