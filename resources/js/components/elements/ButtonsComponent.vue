    ...
    <section class="buttons-block container">
        <ul class="buttons-block-list">
            <li>
                ...
                v-on:click.prevent="show('Узнать про кредит', 'main__modal_btn-credit', 'Отправить', 1, 'credit')"/>
            </li>
            <li>
                <img class="buttons-block-list-exchange event" src="/build/images/main/buttons_block/exchange.png" alt="Брайт Парк: обмен"
                v-on:click.prevent="show('Узнать про обмен', 'main__modal_btn-exchange', 'Отправить', 1, 'obmen')"/>
            </li>
            <li>
            ...
            <li>
                ...
                v-on:click.prevent="show('Записаться на тест-драйв', 'main__modal_btn-test-drive', 'Записаться', 1, 'test_drive')"/>
            </li>
        </ul>
