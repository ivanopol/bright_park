    ...
    <body>
        ...
        <div class="container p-top-90">
            <div class="news-wrapper">
                ...
                @foreach($news as $new)
                    <div class="new-row">
                        <a href="{{ route('news_details', ['city' => $city_info->alias, 'news_title' => $new->slug]) }}" class="new-title">{{$new->title}}</a>
                        <div class="new-content-wrap">
                            <div class="new-img">
                                <a href="{{ route('news_details', ['city' => $city_info->alias, 'news_title' => $new->slug]) }}">
                            ...
                            <div class="new-text-wrap">
                                ...
                                <div class="new-button">
                                    <a href="{{ route('news_details', ['city' => $city_info->alias, 'news_title' => $new->slug]) }}" class="btn btn-primary">Читать</a>
                                </div>
                            </div>
                        </div>
