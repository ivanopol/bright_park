        ...
        $data = [
            ...
            'reviews' => [
                [
                    ...
                    'author' => 'портал КОЛЕСА.ру'
                ],
                [
                    'quote' => 'Обновлённая Гранта предлагается с четырьмя типами кузова: кроме традиционного седана, это лифтбек, хэтчбек и даже универсал! Такое богатство выбора позволяет потенциальному покупателю точно подобрать вариант по вкусу и потребностям – кому-то подавай "строгий" трехобъемник, другим больше нравится универсал, а "молодые и горячие" наверняка предпочтут хэтчбек или лифтбек.',
                    'author' => 'портал КОЛЕСА.ру'
                ],
                [
                    'quote' => 'Среди покупателей этой машины до сих пор много тех, кто и техобслуживание, и ремонт ведёт своими силами, в гараже. И Гранта позволяет это делать – в обслуживании она проста, запчасти доступны и недороги, а в интернете сейчас полно мануалов по любому техническому вопросу. С другой стороны, даже если вы выбираете фирменный сервис, то Гранта обойдётся вам в сумму куда меньшую, чем абсолютное большинство современных автомобилей.',
                    'author' => 'портал КОЛЕСА.ру'
                ]
            ]
        ];
