...
За что страна гордится Нивой, так это за ее сумасшедшую проходимость. ',
            ...
            [
                ...
                'quote' => 'Приборная панель LADA X-Ray ультраспортивна – словно это гоночный автомобиль. Стильная бело-зеленая шкала приборов, чёткие стрелки – ничего лишнего. 
Зато багажнику LAD X-Ray может позавидовать практически любой компактный кроссовер.',
                'author' => 'портал <cite>carexpert.ru</cite>'
            ],
            // XRAY
            // XRAY
